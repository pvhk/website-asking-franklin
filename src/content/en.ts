...
export const enContent: SiteContent = {
  ...
  freeTools: {
    ...
    serpPreview: {
      meta: {
        title: 'Free SERP Preview Tool - Check Your Meta Tags | Asking Franklin',
        description: 'Preview how your page appears in Google search results. Check meta title length, description length, and keyword placement with our free SERP snippet preview tool.',
      },
      title: 'Free SERP Preview Tool',
      subtitle: 'See exactly how your page will appear in Google search results. Check your meta title, description, and URL in real-time.',
      titleLabel: 'Meta Title',
      titlePlaceholder: 'Enter your page title',
      descriptionLabel: 'Meta Description',
      descriptionPlaceholder: 'Enter your meta description',
      urlLabel: 'Page URL',
      urlPlaceholder: 'https://www.example.com/my-page',
      ...
      checks: {
        ...
        titleLengthGood: 'Good length (30-60 characters)',
        titleLengthWarning: 'Slightly long (may be truncated)',
        titleLengthBad: 'Too short or too long',
        descLength: 'Description length',
        descLengthGood: 'Good length (120-160 characters)',
        descLengthWarning: 'Slightly short or long',
        descLengthBad: 'Too short or too long',
        keywordInTitle: 'Keyword in title',
        keywordInTitleGood: 'Keyword found in title',
        keywordInTitleBad: 'Keyword not found in title',
        keywordInDesc: 'Keyword in description',
        keywordInDescGood: 'Keyword found in description',
        keywordInDescBad: 'Keyword not found in description',
        keywordAtStart: 'Keyword near the start of the title',
        keywordAtStartGood: 'Keyword appears in the first half of the title',
        keywordAtStartBad: 'Consider placing the keyword earlier in the title',
      },
      cta: {
        title: 'Generate perfect meta tags automatically',
        description: 'Asking Franklin generates optimized meta titles and descriptions for every article, based on SERP analysis and search intent.',
        button: 'Start your free trial',
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { question: 'What is the ideal meta title length?', answer: 'Google typically displays the first 50-60 characters of a title tag. Aim for 30-60 characters to ensure your full title is visible in search results.' },
          { question: 'What is the ideal meta description length?', answer: 'Google usually shows 150-160 characters of a meta description on desktop and around 120 on mobile. Aim for 120-160 characters for best results.' },
          { question: 'Does Google always use my meta description?', answer: 'No. Google may choose to display a different snippet from your page content if it considers it more relevant to the user\'s query. However, a well-written meta description increases the chances of it being used.' },
          { question: 'Should I include my keyword in the meta title?', answer: 'Yes. Including your target keyword in the meta title is one of the most important on-page SEO factors. Place it as early as possible in the title for maximum impact.' },
          { question: 'What is a SERP snippet?', answer: 'A SERP snippet is the preview of your page shown in Google search results. It typically includes the page title (blue link), URL (breadcrumb), and meta description.' },
        ],
      },
    },
    wordCounter: {
      meta: {
        title: 'Free Word Counter & Content Analyzer - SEO Tool | Asking Franklin',
        description: 'Count words, characters, sentences, and paragraphs. Analyze keyword density, readability score, and reading time with our free content analysis tool.',
      },
      title: 'Free Word Counter & Content Analyzer',
      subtitle: 'Analyze your content in real-time. Count words, check keyword density, measure readability, and get insights to improve your writing.',
      ...
      densityTitle: 'Keyword Density',
      readabilityTitle: 'Readability',
      topKeywordsTitle: 'Top Keywords',
      cta: {
        title: 'Go beyond counting words',
        description: 'Asking Franklin analyzes search intent, SERP competition, and writes SEO-optimized content that ranks on Google and AI engines.',
        button: 'Start your free trial',
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { question: 'How many words should a blog post be for SEO?', answer: 'There is no magic number, but studies show that long-form content (1,500-2,500+ words) tends to rank higher. The ideal length depends on the topic, competition, and search intent. Focus on covering the topic thoroughly rather than hitting a specific word count.' },
          { question: 'What is keyword density and why does it matter?', answer: 'Keyword density is the percentage of times your target keyword appears relative to the total word count. A density of 1-3% is generally recommended. Too low and search engines may not understand your topic; too high and it can be seen as keyword stuffing.' },
          { question: 'What is a good Flesch readability score?', answer: 'A Flesch Reading Ease score of 60-70 is considered ideal for most web content (easily understood by 13-15 year olds). Scores above 70 are easy to read, while scores below 30 are very difficult. Aim for 50-70 for blog content.' },
          { question: 'Does word count affect SEO rankings?', answer: 'Word count itself is not a direct ranking factor, but comprehensive content that thoroughly covers a topic tends to rank better. Longer content often naturally includes more relevant keywords and answers more user questions.' },
          { question: 'What is the ideal reading time for a blog post?', answer: 'Studies suggest 7-10 minutes (about 1,600-2,400 words) is the sweet spot for engagement. However, the best reading time depends on your audience and content type. Always prioritize quality over length.' },
        ],
      },
    },
    schemaGenerator: {
      meta: {
        title: 'Free Schema Markup Generator - JSON-LD Tool | Asking Franklin',
        description: 'Generate Schema.org structured data in JSON-LD format. Create markup for Articles, FAQs, Products, LocalBusiness, HowTo, and more with our free tool.',
      },
      title: 'Free Schema Markup Generator',
      subtitle: 'Generate valid JSON-LD structured data for your website. Choose a schema type, fill in the fields, and copy the generated markup.',
      schemaTypeLabel: 'Schema Type',
      generateButton: 'Generate',
      copyButton: 'Copy JSON-LD',
      copiedMessage: 'Copied to clipboard!',
      previewLabel: 'JSON-LD Output',
      cta: {
        title: 'Structured data, automatically',
        description: 'Asking Franklin adds Article and FAQ structured data to every piece of content it generates. Focus on writing, we handle the technical SEO.',
        button: 'Start your free trial',
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { question: 'What is Schema markup?', answer: 'Schema markup (or structured data) is code you add to your pages to help search engines understand your content better. It uses the Schema.org vocabulary to describe things like articles, products, FAQs, and businesses in a machine-readable format.' },
          { question: 'Does Schema markup help SEO?', answer: 'Yes. While Schema markup is not a direct ranking factor, it enables rich snippets (stars, FAQ dropdowns, prices, etc.) in search results, which can significantly improve click-through rates. It also helps search engines understand and index your content more accurately.' },
          { question: 'What is JSON-LD?', answer: 'JSON-LD (JavaScript Object Notation for Linked Data) is the recommended format for adding structured data to web pages. It is a script tag added to the HTML head or body that contains the schema markup in JSON format. Google recommends JSON-LD over other formats like Microdata or RDFa.' },
          { question: 'Which Schema types are most important for SEO?', answer: 'The most impactful types are: Article (for blog posts), FAQPage (for FAQ sections), Product (for e-commerce), LocalBusiness (for local SEO), HowTo (for tutorials), and BreadcrumbList (for site navigation). Choose the type that best matches your content.' },
          { question: 'How do I test my structured data?', answer: 'Use Google\'s Rich Results Test (search.google.com/test/rich-results) to validate your JSON-LD markup. It will show you any errors or warnings and preview how your rich snippet may appear in search results.' },
        ],
      },
    },
  },
